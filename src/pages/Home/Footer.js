...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-center pt-10 bg-[#3c6982] text-white">
            <div>
                ...
                <p className="font-bold">
                    Algosoft Ltd. <br />Providing software solutions since 2022
                </p>
            </div>
            <div>
                <div className="grid grid-flow-col gap-4">
                    ...
                    <a>
                        <FontAwesomeIcon className='w-6 h-6' icon={faGooglePlusG} />
                    </a>
                </div>
            </div>
            <div className='text-white bg-black w-full py-2'>
                <p>Copyright © 2022 - All right reserved by Algosoft Ltd</p>
            </div>
        </footer>
    );
};
